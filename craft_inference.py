...
parser.add_argument('--test_folder', default='/home/ram/Projects/OCR/craft_tflite/data/', type=str, help='folder path to input images')
...
if __name__ == '__main__':
    ...
    if not Path(args.trained_model).exists():
        ...
        wget.download('https://drive.google.com/uc?export=download&id=1aJxFDo4l02y9cBPNt1-Duc5PsimLB_rw')
